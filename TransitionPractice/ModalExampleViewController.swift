...
class ModalExampleViewController: ElasticModalViewController {
  ...
  @IBAction func showMore(_ sender: AnyObject) {
    let nextViewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "ModalExampleViewController") as! ModalExampleViewController
